...
from textoEmFala_v2 import transcreverTextoEmFala


def menu():
    print('\n*** Deseja ouvir o áudio da tradução? ***\n')
    print('1. Não [default]')
    print('2. Sim')
    ...
    recognize_from_microphone(audio)
    

def recognize_from_microphone(audio=False):
    ...
    if audio:
        transcreverTextoEmFala(translation_recognition_result.translations[target_language], nome, idioma)
